...
Called by scripts.common.schema_registry.validate_document after schema validation
passes, so every caller (CLI, hooks, skills, harness) gets the same checks.
"""
